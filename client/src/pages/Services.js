...
function Services() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-50 via-purple-50 to-blue-50 flex items-center justify-center px-6">
      <div className="max-w-4xl w-full text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {services.map((service, index) => (
            <div
              key={index}
              className="p-6 bg-gradient-to-br from-white to-purple-50 shadow-lg rounded-lg transform transition duration-300 hover:-translate-y-2 hover:shadow-2xl"
            >
