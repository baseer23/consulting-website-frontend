...
function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-300 flex flex-col items-center justify-center py-4 sm:py-8 space-y-12" style={{ paddingTop: '4rem' }}>
      {/* Calendly Section */}
